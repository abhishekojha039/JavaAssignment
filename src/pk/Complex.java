...
class Complex {
    ...
    void addition(int a1, int a2, int b1, int b2){
        int s1, s2;
        s1 = a1+b1;
        s2 = a2+b2;
    ...
    void difference(int a1, int a2, int b1, int b2){
        int s1, s2;
        s1 = a1-b1;
        s2 = a2-b2;
    ...
    public static void main(String[] args) {
        ...
        c1.addition(n1, n2, m1, m2);
        c1.difference(n1, n2, m1, m2);
        c1.product(n1, n2, m1, m2);
    }
}
